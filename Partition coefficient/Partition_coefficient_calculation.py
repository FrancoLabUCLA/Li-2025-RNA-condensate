        ...
        if os.path.exists(mask_path):
            ...
            if inside_val is not None:
                ...
                if os.path.exists(inside_crop_path):
                    inside_crop = tifffile.imread(inside_crop_path)
            ...
            if outside_val is not None:
                ...
                if os.path.exists(outside_crop_path):
                    outside_crop = tifffile.imread(outside_crop_path)
...
if __name__ == '__main__':
    ...
    directory = 'C:/Users/sjtu_/Box/2. Lab/Condensate Volume Quantification/GwtBr/'
